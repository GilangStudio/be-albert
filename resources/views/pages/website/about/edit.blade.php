...
<div class="row">
    <div class="col-12">
        <form action="{{ route('about.update', $about->id) }}" method="POST" class="card" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="mb-3 image-preview d-flex flex-column">
                            ...
                            <img src="{{ asset('storage/website/about/' . $about->image) }}" alt="" height="300" onclick="triggerFile()" class="object-fit-contain img-border mb-2">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="quill-content" style="height: auto">{!! old('content') ?? $about->content !!}</div>
                        </div>
                        <div class="mb-3">
                                ...
                                <div class="list-group-radio w-100">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6 col-md-3">
                                            <input class="form-check-input position-absolute top-50 end-0 fs-5 d-none" type="radio" name="layout" id="layout-1" value="true" {{ old('layout') == 'true' || $about->layout == 1 ? 'checked' : '' }} required>
                                        ...
                                        <div class="col-6 col-md-3">
                                            <input class="form-check-input position-absolute top-50 end-0 fs-5 d-none" type="radio" name="layout" id="layout-2" value="false" {{ old('layout') == 'false' || $about->layout == 0 ? 'checked' : '' }} required>
                                            <div class="card border border-1 list-group-item mb-0 h-100">
                                                <div class="card-body text-center p-0">
