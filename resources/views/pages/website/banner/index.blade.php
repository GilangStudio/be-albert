                ...
                <div>
                    ...
                    <div class="modal fade" id="modal-sort" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <form action="{{ route('banner.sort') }}" method="post">
                                @csrf
                                                ...
                                                @foreach ($banners as $item)
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <img src="{{ asset('storage/website/banners/'.$item->image) }}" height="200" class="object-fit-contain w-100">
                                                        </div>
                                                    </li>
                                                    {{-- @endif --}}
                                                @endforeach
                    ...
                    <table class="table" id="table-banner">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/website/banners/' . $banner->image) }}" alt="" height="100" width="100" class="object-fit-contain img-border">
                                </td>
                                        ...
                                        <div class="button-items">
                                            ...
                                            <div class="modal fade" id="modal-banner-edit-{{ $banner->id }}" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <form action="{{ route('banner.update', $banner->id) }}" method="POST" class="modal-content" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-12 image-preview d-flex flex-column">
                                                                    ...
                                                                    <img src="{{ asset('storage/website/banners/' . $banner->image) }}" alt="" height="300" onclick="triggerFile({{ $banner->id }})" class="object-fit-contain img-border mb-2">
...
<script>
    $(function () {
      $('#modal-delete').on('show.bs.modal', function (event) {
        ...
        modal.find('form').attr('action', `{{ route('banner.destroy', '') }}/` + id)
