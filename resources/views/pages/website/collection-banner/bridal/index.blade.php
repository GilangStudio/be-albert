...
@section('title', 'Bridal Banner')

@section('breadcrumb')
<li class="breadcrumb-item">Website</li>
<li class="breadcrumb-item active">Bridal Banner</li>
@endsection
...
<div class="row">
    <div class="col-12">
        <form class="card" action="{{ route('collection-banner.bridal.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12">
                        <label for="images" class="form-label">Bridal Banner Images</label>
...
<div class="row">
    <div class="col-12">
        <form action="{{ route('collection-banner.bridal.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Bridal Banner Description</h4>
                </div><!--end card-header-->
                <div class="card-body">
...
<div class="modal fade" id="modal-sort" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('collection-banner.bridal.sort') }}" method="post">
            @csrf
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h6 class="modal-title m-0 text-white">Sort Bridal Banner Images</h6>
