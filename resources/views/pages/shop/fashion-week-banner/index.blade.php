...
@section('title', 'Fashion Week Banner')

@section('breadcrumb')
<li class="breadcrumb-item">Shop</li>
<li class="breadcrumb-item active">Fashion Week Banner</li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="card-title">Fashion Week Banner</h4>
                </div>
                <div>
                    ...
                    <div class="modal fade" id="modal-sort" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <form action="{{ route('shop.fashion-week-banner.sort') }}" method="post">
                                @csrf
                                                ...
                                                @foreach ($banners as $item)
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <img src="{{ asset('storage/shop/fashion-week-banners/'.$item->image) }}" height="200" class="object-fit-contain w-100">
                                                        </div>
                                                    </li>
                                                    {{-- @endif --}}
                                                @endforeach
                    ...
                    <table class="table" id="table-banner">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/shop/fashion-week-banners/' . $banner->image) }}" alt="" height="100" width="100" class="object-fit-contain img-border">
                                </td>
                                        ...
                                        <div class="button-items">
                                            ...
                                            <div class="modal fade" id="modal-banner-edit-{{ $banner->id }}" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <form action="{{ route('shop.fashion-week-banner.update', $banner->id) }}" method="POST" class="modal-content" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-12 image-preview d-flex flex-column">
                                                                    ...
                                                                    <img src="{{ asset('storage/shop/fashion-week-banners/' . $banner->image) }}" alt="" height="300" onclick="triggerFile({{ $banner->id }})" class="object-fit-contain img-border mb-2">
...
<div class="modal fade" id="modal-banner-create" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="{{ route('shop.fashion-week-banner.store') }}" method="POST" class="modal-content" enctype="multipart/form-data">
            @csrf
            <div class="modal-header bg-primary">
...
<script>
    $(function () {
      $('#modal-delete').on('show.bs.modal', function (event) {
        ...
        modal.find('form').attr('action', `{{ route('shop.fashion-week-banner.destroy', '') }}/` + id)
